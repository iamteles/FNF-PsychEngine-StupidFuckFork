...
class PlayState extends MusicBeatState
{
	...
	public dynamic function updateScoreText()
	{
		...
		var str:String = percent + "%" + ' [${getRank(percent)}]';
	...
	var prevRating:RatingSprite = null;
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		var rating:RatingSprite = new RatingSprite(daRating.image, combo, uiPrefix, uiPostfix);
		...
		rating.setPos(daX, ClientPrefs.data.downScroll ? FlxG.height - 100 : 100);
	}
